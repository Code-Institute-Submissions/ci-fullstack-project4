# Generated by Django 2.2.14 on 2020-08-23 04:38
...
def create_and_add_group_permissions(apps, schema_editor):
    ...
    permission1 = Permission.objects.get(
        name='Can view household')
    permission2 = Permission.objects.get(
        name='Can add household')
    permission3 = Permission.objects.get(
        name='Can change household')
    permission4 = Permission.objects.get(
        name='Can delete household')
    permission5 = Permission.objects.get(
        name='Can view member')
    permission6 = Permission.objects.get(
        name='Can add member')
    permission7 = Permission.objects.get(
        name='Can change member')
    permission8 = Permission.objects.get(
        name='Can delete member')
    permission9 = Permission.objects.get(
        name='Can view storage location')
    permission10 = Permission.objects.get(
        name='Can add storage location')
    permission11 = Permission.objects.get(
        name='Can change storage location')
    permission12 = Permission.objects.get(
        name='Can delete storage location')
    permission13 = Permission.objects.get(
        name='Can view food item')
    permission14 = Permission.objects.get(
        name='Can add food item')
    permission15 = Permission.objects.get(
        name='Can change food item')
    permission16 = Permission.objects.get(
    ...
    member_permissions = [permission9, permission10, permission11,
                          permission12, permission13, permission14,
